...
DROP TABLE C_REPLY_BOARD CASCADE CONSTRAINTS;
...
DROP TABLE STARTUP_BOARD CASCADE CONSTRAINTS;
...
(
	SA_NO varchar2(10) NOT NULL,
	REPODATE date DEFAULT SYSDATE NOT NULL,
	-- 일반회원과 사업자 회원 모두를 포함
	-- 
	-- TIP.
	-- C001
	-- S002  앞의 문자를 활용하여 회원종류 구분
...
ALTER TABLE C_REPLY_BOARD
	ADD FOREIGN KEY (NO)
	REFERENCES STARTUP_BOARD (NO)
;
...
COMMENT ON COLUMN APPLICANT.PNO IS '일반회원과 사업자 회원 모두를 포함
...
COMMENT ON COLUMN EVENT.BOARDTYPE IS '1 = 메인행사게시판
2 = 지역행사게시판';
